...
<fieldset class="site_search">
   ...
   ?>
     <div style="margin: 50px auto;width: 500px;background-color: yellow;padding: 50px 0;border: 1px solid #ddd;box-shadow: 10px 10px 5px #888888">
         <p style="text-align: center;color: #333;font-size: 20px;font-weight: bold;">Result Not Found .. Please Try Again</p>
     </div>
